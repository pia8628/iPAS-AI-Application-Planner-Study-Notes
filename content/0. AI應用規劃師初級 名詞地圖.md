...
- 台灣 AI 
	...
	- 台灣主權 AI：[TAIDE](TAIDE.md) 
		...
		- [TTQA 臺灣常識問答集](TTQA%20臺灣常識問答集.md)
	- 台灣 AI 雲（TWCC）
...
- 調校與優化
	...
	- [LoRA 低秩適應](LoRA%20低秩適應.md)
	- [知識蒸餾](知識蒸餾.md)：模型優化與壓縮
- [MLOps 機器學習運作](MLOps%20機器學習運作.md)
### 深度學習
[[深度學習-深度神經網路|深度學習]]
- 學習模型
- 前向與反向傳播
...
- 提示工程
	- [CoT思維鏈 與 ToT樹狀思維](CoT思維鏈%20與%20ToT樹狀思維.md)
	- [APE 自動提示工程](APE%20自動提示工程.md)
